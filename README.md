...
* Some useful rsync default options are pre-configured. These can be overridden if desired.
* The rsync exclude option is derived from your `.gitignore` and `.dockerignore` files. These can be overridden if desired.
